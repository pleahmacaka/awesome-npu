#!/usr/bin/env node
/**
 * Awesome NPU — GitHub Pages renderer.
 * Data parsing lives in ./catalog.mjs; this file renders pages + sitemap.
 */
import fs from 'node:fs';
import path from 'node:path';
import { products, mainProducts, dcProducts, I18N, EI18N, ENRICH, LANGS, PAGES_URL, REPO_URL, ROOT, escHtml, vendorSlug, introHTML, docsHTML, DATA, template, usedKeys } from './catalog.mjs';
